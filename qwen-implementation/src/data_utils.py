...
MTS-Dialog  → /scratch/akarim9/mediqa-chat/dataset/MTS-Dialog/
  task: dialogue → (section_header, section_text)
  splits: train 1201 / validation 100 / test1 200 
"""
...
_MTS_ROOT = "/scratch/akarim9/mediqa-chat/dataset/MTS-Dialog"
...
_ACI_ROOT = "/scratch/akarim9/mediqa-chat/dataset/aci/data/challenge_data_json"
